    ...
    <div className="page-container">
      <div className="page-header">
        <div>
          ...
          <p>Track and calculate your GPA and CGPA</p>
        </div>
        <button 
        ...
        <div className="grades-grid">
            ...
            return (
              ...
              >
                ...
                <div className="grade-details">
                  <div className="grade-badge" style={{ backgroundColor: gradeColor + '20', color: gradeColor }}>
                    {grade.grade}
                  </div>
                  <div className="grade-info">
                    <span className="grade-label">Credits:</span>
                    <span>{grade.credits}</span>
                  </div>
                  {grade.semester && (
                    <div className="grade-info">
                      <span className="grade-label">Semester:</span>
                      <span>{grade.semester}</span>
                    </div>
                  )}
                  {grade.grade && grade.credits && (
                    <div className="grade-points">
                      Points: {(gradePoints[grade.grade] || 0) * parseFloat(grade.credits || 0)}
                    </div>
                  )}
                </div>
              </div>
          ...
          {grades.length === 0 && (
            <div className="empty-state">
              <p>No grades yet. Add your first grade to start tracking your GPA!</p>
            </div>
          )}
        </div>
      </div>
